    ...
    <main>
        <div class="container">
            ...
            <form id="login" novalidate method="post">
                ...
                <button type="submit" id="login-btn">REGISTRATI</button>
            </form>
            <p class="register">Sei già registrato? Accedi <a href="/?login">qui</a>.</p>
        </div>
    </main>
    <script>
        document.getElementById("login").addEventListener("submit", function(event){
            ...
            let data = {
                ...
                name: document.getElementById("name").value.length > 2 && document.getElementById("name").value.length < 50,
                surname: document.getElementById("surname").value.length > 2 && document.getElementById("surname").value.length < 50
            }
            console.log(data)
            let error = false
            if(!data.email){
            ...
            fetch('https://andrew02.it/api/register', {
                method: "POST",
