...
<script>
    ...
    getData()
    function getData(){
        fetch('https://andrew02.it/api/getGenders', {
            method: "GET",
    ...
    function saveData(id, value){
        fetch('https://andrew02.it/api/saveGender', {
            method: "POST",
            headers: { "Content-Type": "application/json" },
    ...
    function deleteData(id, value){
        fetch('https://andrew02.it/api/deleteGender', {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ id: id, value: value})
        })
    ...
    function createData(value){
        fetch('https://andrew02.it/api/createGender', {
            method: "POST",
            headers: { "Content-Type": "application/json" },
