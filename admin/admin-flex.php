...
<script>
    ...
    getData()
    function getData(){
        fetch('https://andrew02.it/api/getFlexs', {
            method: "GET",
    ...
    function saveData(id, value){
        fetch('https://andrew02.it/api/saveFlex', {
            method: "POST",
            headers: { "Content-Type": "application/json" },
    ...
    function deleteData(id, value){
        fetch('https://andrew02.it/api/deleteFlex', {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ id: id, value: value})
        })
    ...
    function createData(value){
        fetch('https://andrew02.it/api/createFlex', {
            method: "POST",
            headers: { "Content-Type": "application/json" },
