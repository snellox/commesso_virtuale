...
<script>
    ...
    getData()
    function getData(){
        fetch('https://andrew02.it/api/getBrands', {
            method: "GET",
    ...
    function saveData(id, value){
        fetch('https://andrew02.it/api/saveBrand', {
            method: "POST",
            headers: { "Content-Type": "application/json" },
    ...
    function deleteData(id, value){
        fetch('https://andrew02.it/api/deleteBrand', {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ id: id, value: value})
        })
    ...
    function createData(value){
        fetch('https://andrew02.it/api/createBrand', {
            method: "POST",
            headers: { "Content-Type": "application/json" },
