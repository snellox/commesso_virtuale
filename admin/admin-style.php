...
<nav id="navbar">
    <div class="container">
        ...
        <div class="page">STYLE OF RIDING</div>
        <div></div>
    </div>
</nav>
...
<script>
    ...
    getData()
    function getData(){
        fetch('https://andrew02.it/api/getStyles', {
            method: "GET",
    ...
    function saveData(id, value){
        fetch('https://andrew02.it/api/saveStyle', {
            method: "POST",
            headers: { "Content-Type": "application/json" },
    ...
    function deleteData(id, value){
        fetch('https://andrew02.it/api/deleteStyle', {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ id: id, value: value})
        })
    ...
    function createData(value){
        fetch('https://andrew02.it/api/createStyle', {
            method: "POST",
            headers: { "Content-Type": "application/json" },
